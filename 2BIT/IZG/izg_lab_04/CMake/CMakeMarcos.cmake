...
macro(findImgui)
    set(Imgui_DIR  "${CMAKE_CURRENT_SOURCE_DIR}/3rdPartyLibs/imgui" CACHE PATH "Imgui root folder")
endmacro()
...
macro(create_install_post_build_step target_name)
   ...
   add_custom_command(TARGET ${target_name} POST_BUILD        
                       COMMAND ${CMAKE_COMMAND} -E copy_if_different "${CMAKE_CURRENT_SOURCE_DIR}/monkey.obj" ${CMAKE_CURRENT_BINARY_DIR})  
   add_custom_command(TARGET ${target_name} POST_BUILD        
                       COMMAND ${CMAKE_COMMAND} -E copy_if_different "${CMAKE_CURRENT_SOURCE_DIR}/step_1_bunny.obj" ${CMAKE_CURRENT_BINARY_DIR})  
   add_custom_command(TARGET ${target_name} POST_BUILD        
                       COMMAND ${CMAKE_COMMAND} -E copy_if_different "${CMAKE_CURRENT_SOURCE_DIR}/step_2_bunny.obj" ${CMAKE_CURRENT_BINARY_DIR})  
   add_custom_command(TARGET ${target_name} POST_BUILD        
                       COMMAND ${CMAKE_COMMAND} -E copy_if_different "${CMAKE_CURRENT_SOURCE_DIR}/step_1_monkey.obj" ${CMAKE_CURRENT_BINARY_DIR})         
   add_custom_command(TARGET ${target_name} POST_BUILD        
                       COMMAND ${CMAKE_COMMAND} -E copy_if_different "${CMAKE_CURRENT_SOURCE_DIR}/step_2_monkey.obj" ${CMAKE_CURRENT_BINARY_DIR})  
   add_custom_command(TARGET ${target_name} POST_BUILD        
                       COMMAND ${CMAKE_COMMAND} -E copy_if_different "${CMAKE_CURRENT_SOURCE_DIR}/transformed_bunny.obj" ${CMAKE_CURRENT_BINARY_DIR})  
   add_custom_command(TARGET ${target_name} POST_BUILD        
                       COMMAND ${CMAKE_COMMAND} -E copy_if_different "${CMAKE_CURRENT_SOURCE_DIR}/transformed_monkey.obj" ${CMAKE_CURRENT_BINARY_DIR})  
endmacro()
