 ...
 * the first argument
 */
ArgumentViewer::ArgumentViewer(int argc, char const*argv[]) {
  if (argc <= 0)
...
/**
 * @brief Non const constructor for const correctness.
 * int main(int argc,char*argv[]) - argv has to be non const.
 *
 * @param argc nof arguments
 * @param argv arguments
 */
ArgumentViewer::ArgumentViewer(int argc, char *argv[]):ArgumentViewer(argc,(const char**)argv) {
}
