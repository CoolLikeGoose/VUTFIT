...
void DLL_InsertAfter( DLList *list, int data ) {
	...
	elToAdd->previousElement = list->activeElement;								//		Connect new node to neighborhoods
...
void DLL_InsertBefore( DLList *list, int data ) {
	...
	elToAdd->previousElement = list->activeElement->previousElement;			//		Connect new node to neighborhoods
